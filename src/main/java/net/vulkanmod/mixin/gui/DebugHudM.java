...
//     */
    ...
    public void drawGameInformation(GuiGraphics matrices) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            GuiBatchRenderer.fill(matrices.pose(), 1, m - 1, 2 + k + 1, m + j - 1, -1873784752);
        }
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            GuiBatchRenderer.drawString(this.font, bufferSource, matrices.pose(), string, 2.0f, (float)m, 0xE0E0E0);
        }
    ...
    public void drawSystemInformation(GuiGraphics matrices) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            GuiBatchRenderer.fill(matrices.pose(), l - 1, m - 1, l + k + 1, m + j - 1, -1873784752);
        }
        GuiBatchRenderer.endBatch();
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            GuiBatchRenderer.drawString(this.font, bufferSource, matrices.pose(), string, (float)l, (float)m, 0xE0E0E0);
        }
        bufferSource.endBatch();
    }
}
