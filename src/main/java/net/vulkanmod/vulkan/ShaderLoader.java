...
public class ShaderLoader
{
    ...
    static final String defDir = (System.getProperty("user.dir")+"/shaders/");
    ...
    public static long bufferShaders(String name) {
        try(final FileInputStream fileInputStream = new FileInputStream(defDir+name))
        {
